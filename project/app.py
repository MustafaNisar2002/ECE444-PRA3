...
# Database URL: prefer DATABASE_URL (Render Postgres), otherwise local SQLite
...
def add_entry():
    """Add a new post (must be logged in)."""
...
def login():
    """Simple demo auth with hard-coded creds (admin/admin)."""
    error = None
